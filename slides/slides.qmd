...
![](images/ch01-miflow-1.png){fig-alt="" style="filter: drop-shadow(0 0 0.75rem grey);" width=55%}
...
plot_d(paste0("Model predictive mean", emojis$emoji[1]))
...
* Fit the scientific model of interest to each imputed dataset
...
[<span style="color:#666666; font-style: italic;"> <small> Missing values in imaging data </small> </span>]{.absolute left=950 top=540}
...
:::{.incremental}
* Less mature, but `statsmodels.imputation.mice` exists
* Don't use `scikit-learn` 
