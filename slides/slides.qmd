...
Link in my email signature or at [ccb.hms.harvard.edu](ccb.hms.harvard.edu)
...
install.packages(c("tidyverse", "mice"), Ncpus = 4)
```
...
* Output uncertainty surprisingly low
* SHAPEIT
...
**Don't do missing data analysis in Python. **
...
* `scikit-learn` is for machine learning, *not* probabilistic inference 
  * See also the infamous `sklearn.linear_model.LogisticRegression` another guaranteed-to-be-wrong function
