...
![](images/oh.png){.absolute left=900 top=0 width=45%}
...
:::{.absolute left=1160 top=870}
<span style="color: #999999;"> <small> Adapted from R for Data Science (2e) [CC BY-NC-ND 3.0](https://creativecommons.org/licenses/by-nc-nd/3.0/us/) </small> </span>
:::
...
![](images/ya_like_dags.png){fig-align="center" width=90%}
...
:::{layout-nrow=1}
![](images/ggmice_preview2.png){height=520}
![](images/ggmice_preview.png){height=520}
:::
...
![](images/2025-09-19_10-23-13.png){fig-alt="" style="filter: drop-shadow(0 0 0.75rem grey);" .absolute left=100 width=45% top=600}
...
![](images/2025-07-01_13-17-22.png){fig-alt="" style="filter: drop-shadow(0 0 0.75rem grey);" .absolute top=440 width=44% left=450} 
...
[Rethinking Ch11](https://bookdown.org/content/4857/god-spiked-the-integers.html#bonus-survival-analysis)

![](images/survival_ex.png){fig-alt="" style="filter: drop-shadow(0 0 0.75rem grey);" .absolute left=500 top=650 width=35%}
